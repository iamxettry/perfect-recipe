...
const MenuItemCard = ({ data }) => {
  return (
    <Link to={`/recipe/${data?.title.replace(/\s+/g, '-')}?id${data.id}`} className="block  rounded-lg border border-neutral-300 hover:scale-105 transition duration-300 ease-linear">
